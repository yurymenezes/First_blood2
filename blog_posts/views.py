...
class PostCategoria(PostIndex):
    ...
    template_name = 'blog_posts/posts_categoria.html'#direcionando para o template
...
class PostDetalhes(UpdateView):
    ...
    template_name = 'blog_posts/post_detalhes.html'#direcionando para o template
    model = Post #model usado para preencher 
    ...
    def get_context_data(self, **kwargs):
        ...
        comentarios = Comentario.objects.filter(publicad_comentario=True,
